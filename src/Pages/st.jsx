...
<hr className='h-2 w-[100%]'></hr>
                <div className='flex  h-[25%] w-[100%] items-center'>
                    ...
                    <div className='bg-amber-900 w-[15%]'>
                        <img className='' src='http://res.cloudinary.com/dwruhrrkm/image/upload/v1739202953/y6bhmxwhu31l3y1js3en.png' />
                    </div>
                    <div className='flex justify-start items-start gap-3 mx-auto'>
                        <div> İsim: Porche</div>
                        <div> Fiyat: 250TL</div>
                        <div> İndirim: 25</div>
                        <div> Renkler: Mavi,Sarı,Turuncu</div>
                        <div> Boyutlar: S:25,M:31</div>
